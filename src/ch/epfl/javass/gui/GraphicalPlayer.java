...
public final class GraphicalPlayer {
     ...
     * @param playerMap
     *            map with the names of each player associated to its id
     * @param score
     * @param trick
     * @param hand
     * @param commQueue
     *            array that will be used for the communication of the card to
     ...
     * 
     * @param team
     *            that you want to get the names of the players
     ...
     * 
     * @param ownId
     *            id of the player you want to know which card he played
     ...
     * 
     * @param team
     *            that we want to create its pane
...
//        victoryPane.setBottom(wantRevenge);
     ...
     * 
     * @param c
     *            color of the symbol we want to have the image
